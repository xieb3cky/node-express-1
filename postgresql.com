...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2022-07-07T18:58:09.534313" />
  ...
  <link href="/media/css/fontawesome.css?e68426d2" rel="stylesheet">
  <link rel="stylesheet" href="/media/css/bootstrap-4.4.1.min.css">
  <link rel="shortcut icon" href="/favicon.ico" />
  
    <link rel="stylesheet" type="text/css" href="/dyncss/base.css?e68426d2">
    ...
    <div class="col-lg-5">
      <div class="sidebar">
        ...
        <ul class="divided">
            ...
            <li>
              <h3><a href="/about/news/pgadmin-4-v611-released-2480/">pgAdmin 4 v6.11 Released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2022-07-06 by pgAdmin Development Team</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/announcing-the-release-of-agensgraph-212-2481/">Announcing the release of AgensGraph 2.12</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2022-07-06 by Bitnine Global</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/postgresql-15-beta-2-released-2479/">PostgreSQL 15 Beta 2 Released!</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2022-06-30 by PostgreSQL Global Development Group</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/odyssey-13-released-2476/">Odyssey 1.3 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2022-06-27 by Yandex</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/parquet-s3-fdw-030-released-2474/">Parquet S3 FDW 0.3.0 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2022-06-23 by Toshiba</li>
              </ul>
            </li>
...
<!-- Blog -->
     ...
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5nd"> PostgreSQL Replication and Conflicts</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Hamid Akhtar</li>
              <li><i class="far fa-clock"></i>&nbsp;2022-07-07</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5n9"> Handling Bonus Programs in SQL</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Hans-Juergen Schoenig</li>
              <li><i class="far fa-clock"></i>&nbsp;2022-07-05</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5n8"> Understanding pg_stat_activity</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5nb"> Queries in PostgreSQL: 5. Nested loop</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5n7"> Julien Tachoires</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Andreas &#x27;ads&#x27; Scherbaum</li>
              <li><i class="far fa-clock"></i>&nbsp;2022-07-04</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5n6"> How to log selects from specific table?</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Hubert &#x27;depesz&#x27; Lubaczewski</li>
              <li><i class="far fa-clock"></i>&nbsp;2022-07-04</li>
            </ul>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5n4"> Database Lab Engine for AWS Marketplace. Fast, fixed-cost branching for your Po</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Nikolay Samokhvalov</li>
              <li><i class="far fa-clock"></i>&nbsp;2022-07-03</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5n5"> PostGIS 3.3.0beta1</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5n2"> PGConf.EU 2022 - Registration and training open</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Magnus Hagander</li>
              <li><i class="far fa-clock"></i>&nbsp;2022-07-01</li>
            </ul>
          </div>
        </div>
 ...
 <!-- END SUBMIT A BUG -->
    ...
    <script src="/media/js/main.js?e68426d2"></script>
